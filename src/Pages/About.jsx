...
const About = () => {
	return (
		<main className="flex md:items-center h-dvh relative bg-cover bg-[url('/bg-explosion.png')]">
			...
			<div className='flex flex-col gap-3 z-[10] lg:pl-40 px-4 pt-16 md:pt-10 xl:pt-30'>
				<h1 className='md:text-5xl text-white max-w-[500px] text-4xl'>
					Hi! I&apos;m <span className='text-red-500 font-semibold'>Brandon</span>
				</h1>
				<p className='flex lg:text-lg text-sm text-gray-200 md:text-gray-100 md:pb-2 max-w-[500px] 2xl:max-w-[600px] 2xl:text-xl'>
