...
const Portfolio = () => {
	...
	return (
		<main className="min-h-screen flex flex-col items-center justify-center mx-auto bg-cover bg-[url('/bg-blur.png')]">
			<div className='flex flex-col items-center justify-center max-w-[900px] px-4 gap-10 my-20 lg:my-0'>
				<h1 className='text-2xl md:text-5xl text-white'>Projects</h1>
				<p className='flex text-3xl md:text-6xl font-extrabold capitalize'>Take a Look at My Work</p>
